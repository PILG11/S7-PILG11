...
<html lang="fr">
  ...
  <body>
    ...
    <div id="bloc">
    <p id="titre_reservation" style="font-size: 23px;"></p>
          ...
          <div style="flex: 0 0 58.333333%; max-width: 58.333333%;">
            <form method="post" action="#" style="display: flex; flex-wrap: wrap;">
              ...
              <div class="formulaire">
                  ...
                  <input id="numero" placeholder="Numero de téléphone" type="text">
                  <label for="event">Type d'évènement : </label>
                  <input id="event" placeholder="Type d'évènement" type="text">
                  ...
                  <button name="submit" value="1" type="submit" class="reserver" style="margin-top: 20px; margin-bottom:0;">Réserver</button>
              </div>
            </form>
          </div>
        </div>
